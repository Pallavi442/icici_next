  ...
  return (
    <div className="max-w-6xl mx-auto text-center p-8">
      ...
      <p className="text-xl mb-6 flex justify-center items-center space-x-4">
        <span className="flex space-x-2 items-center justify-center border-r-2 border-slate-300 pr-4"><span>4.6 </span><img src={star} alt="" /></span> 
        <span className="text-start"><h4>Our customers have rated us</h4><p className="text-gray-500"> Based on 456 reviews</p ></span>
      </p>
      ...
      >
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-8 items-start h-[234px]">
        {displayedReviews.map((r, i) => (
            <div
                key={i}
                className={`p-6 rounded-2xl text-left flex flex-col justify-between ${
                i === 1 ? "hidden lg:block" : ""
                }`}
            >
