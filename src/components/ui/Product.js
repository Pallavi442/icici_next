      ...
      <div className="w-full overflow-x-auto rounded-2xl shadow">
        <table className="min-w-full table-auto text-left border-separate border-spacing-0">
          ...
          <tbody className="text-sm sm:text-base">
            <tr>
              <td className="px-4 py-4 border-r border-gray-300">Private car package policy</td>
              <td className="px-4 py-4 border-r border-gray-300">3001</td>
              <td className="px-4 py-4">IRDAN115RP0017V01200102</td>
            </tr>
            <tr className="bg-[rgba(245,246,246,1)]">
              <td className="px-4 py-4 border-r border-gray-300">Stand-alone own damage private car package policy</td>
              <td className="px-4 py-4 border-r border-gray-300">3001/O</td>
              <td className="px-4 py-4">IRDAN115RP0001V01201920</td>
            </tr>
            <tr>
              <td className="px-4 py-4 border-r border-gray-300">Private car liability policy</td>
              <td className="px-4 py-4 border-r border-gray-300">3001/A</td>
