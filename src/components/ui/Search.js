...
function Search() {
    return (
      <div className="bg-[#F8F6F6] xl:h-[381px]">
        <div className=" py-6 md:py-[64px] px-5  max-w-[1440px] mx-auto overflow-hidden">
          <div className="flex justify-center flex-col lg:flex-row gap-8 md:gap-24 items-start">
