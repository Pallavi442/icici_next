    ...
    return (
        <div className='py-10'>
            ...
            <div className='py-5 px-5 flex justify-between'>
                ...
                <div>
                    <a href="" className="text-[rgb(236_102_8/1)] underline underline-offset-1">Disclaimers</a>
                </div>
            </div>

            <div className='bg-[#ECE9E9] flex py-5 px-5'>
                ...
                <div className='flex w-3/5 flex-col gap-2'>
                    ...
                    <div className="mt-4">
                        <select className="w-1/4 border-b border-b-gray-500  px-3 py-2 text-sm text-gray-700">
